...
osrm-extract \
    ...
    --location-dependent-data /usr/local/share/osrm/data/limited_traffic_zone.geojson \
    --location-dependent-data /usr/local/share/osrm/data/speed_adjustement_zone.geojson \
    --with-osm-metadata \
    -p ${PROFILE} \
