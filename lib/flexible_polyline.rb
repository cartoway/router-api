# Copy from https://github.com/ioki-mobility/flexible-polyline-ruby/blob/main/lib/flexible_polyline/decoder.rb
# MIT License.
# TODO replace with gem, when using at least ruby 2.6
